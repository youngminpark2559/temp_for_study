...
# rm e.l && python run_classifier.py \
# --task_name $TASK_NAME \
# --do_train \
# --do_eval \
# --do_lower_case \
...
# --output_dir /mnt/1T-5e7/mycodehtml/NLP/huggingface/output_run_classifier/$TASK_NAME/ \
# 2>&1 | tee -a e.l && code e.l

# export GLUE_DIR=/mnt/1T-5e7/mycodehtml/NLP/huggingface/glue_task/glue_data&&
...
def convert_examples_to_features(examples, label_list, max_seq_length,tokenizer, output_mode):
  """
  Loads data file into a list of `InputBatch`s.
  """
  ...
  for (ex_index,example) in enumerate(examples):
    ...
    # ================================================================================
    intput_feat=InputFeatures(input_ids=input_ids,input_mask=input_mask,segment_ids=segment_ids,label_id=label_id)
    features.append(intput_feat)
...
def main():
  ...
  if args.do_eval and (args.local_rank==-1 or torch.distributed.get_rank()==0):
    ...
    # ================================================================================
    if output_mode=="classification":
      all_label_ids=torch.tensor([f.label_idforfineval_features],dtype=torch.long)
    elif output_mode=="regression":
      all_label_ids=torch.tensor([f.label_idforfineval_features],dtype=torch.float)
    ...
    with open(output_eval_file,"w")aswriter:
    ...
    if task_name=="mnli":
      ...
      # ================================================================================
      loss=tr_loss/global_stepifargs.do_trainelseNone

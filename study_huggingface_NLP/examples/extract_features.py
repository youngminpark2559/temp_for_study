...
# rm e.l && python extract_features.py \
# --input_file="/mnt/1T-5e7/mycodehtml/NLP/huggingface/samples/input.txt" \
# --output_file="/mnt/1T-5e7/mycodehtml/NLP/huggingface/examples/out_feature_file.json" \
...
def convert_examples_to_features(examples,seq_length,tokenizer):
  ...
  for (ex_index,example) in enumerate(examples):
    ...
    features.append(InputFeatures(
      unique_id=example.unique_id,tokens=tokens,input_ids=input_ids,input_mask=input_mask,input_type_ids=input_type_ids))
...
def main():
  ...
  parser.add_argument("--local_rank",type=int,default=-1,help="local_rankfordistributedtrainingongpus")
  ...
  logger.info("device:{}n_gpu:{}distributedtraining:{}".format(device,n_gpu,bool(args.local_rank!=-1)))

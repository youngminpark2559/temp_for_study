...
# rm e.l && python pregenerate_training_data.py \
# --bert_model="bert-base-uncased" \
# --train_corpus="/mnt/1T-5e7/mycodehtml/NLP/huggingface/samples/sample_text.txt" \
# --output_dir="/mnt/1T-5e7/mycodehtml/NLP/huggingface/Output/pregenerate_training_data" \
...
def main():
    ...
    with DocumentDatabase(reduce_memory=args.reduce_memory) as docs:
        with args.train_corpus.open() as f:
            ...
            # print("doc",doc)
            # [['the', 'fountain', 'of', 'classic', 'wisdom', ',', 'h', '##yp', '##ati', '##a', 'herself', '.'], 

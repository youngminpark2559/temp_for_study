    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        def load(module, prefix=''):
            ...
            if metadata is None:
                ...
                # print("prefix",prefix)
                obtained_prefix=prefix[:-1]
                local_metadata=metadata.get(obtained_prefix, {})
        ...
        # ================================================================================
        # print("len(missing_keys)",len(missing_keys))
        # 2
        ...
        # ================================================================================
        # print("len(unexpected_keys)",len(unexpected_keys))
        # 8
        ...
        # ================================================================================
        # print("len(error_msgs)",len(error_msgs))
        # 0
...
class BertModel(BertPreTrainedModel):
  ...
  def forward(self,input_ids,token_type_ids=None,attention_mask=None,output_all_encoded_layers=True):
    ...
    # this operation will create a tensor which is 0.0 for positions we want to attend 
...
class BertForPreTraining(BertPreTrainedModel):
  ...
  Outputs:
      if `masked_lm_labels` and `next_sentence_label` are not `None`:
          Outputs the total_loss which is the sum of the masked language modeling loss 
          and the next sentence classification loss.
